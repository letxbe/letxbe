...
class TargetMixin(BaseModel):
    ...
    Attributes:
        role (Literal): should be equal to `None`, as opposed to an `Artefact`
        prediction (Prediction): `Prediction` containing information generated by providers about the document.
        feedback (Feedback or None): `Feedback` containing aggregated confirmations, deletions or modifications
            of `TargetMixin.prediction` values.
        current (Current): contains only information that should be considered true,
